...
bool Nivel3::init()
{
    ...
    auto closeItem = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(Nivel3::menuCloseCallback, this));
    ...
    numNivel = Label::createWithTTF("3", "fonts/Marker Felt.ttf", 25); 
	...
	if(i==3 || i==6 || i==9){
		...
		oscuridad1 = Sprite::createWithSpriteFrameName("planta.png");
	...
	auto listener = EventListenerAcceleration::create(CC_CALLBACK_2(Nivel3::onAcceleration, this));
...
void Nivel3::onAcceleration(cocos2d::Acceleration *acc, cocos2d::Event *event)
{
				...
				if(bbObu.intersectsCircle( Vec2(X, Y) , r+1.5) ){
					...
					if(sp->isVisible()){
						...
						/*INSERTA EN LA TABLA*/
					   		...
					   		std::string llave3 = StringUtils::format("%d",this->lvl3);
							std::string score = StringUtils::format("%d",this->puntaje);
			
					   		sql="insert into game  values('"+ llave3 +  "','" + score + "',3)";
